                ...
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <div class="breadcrumb-post-content">
                            <h2 class="post-title">Consulta Contrato</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<?php
	...
	if ($resultado->num_rows > 0) {
								...
								<div class='col-12'>
									...
									<div class='roberto-contact-form'>
											...
											<div class='row'>
												...
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													ID do Imóvel<input type='text' class='form-control mb-30' value = '".$linha['idImovel']."'' readonly='true'><br>
												</div>
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
		...
		echo "<a href='../view/ConsultarContrato.php' style='margin: 0 125px;' class='btn roberto-btn mt-15'>Voltar</a><br>";
	} else {

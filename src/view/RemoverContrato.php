...
<head>
    ...
    <!-- Title -->
    <title>Remoção de Contrato</title>
                ...
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <div class="breadcrumb-post-content">
                            <h2 class="post-title">Remoção de Contrato</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="roberto-contact-form">
                        <form action="..\controller\RemoverContrato.php" method="post">
                            <div class="row">
                                ...
                                <button type="submit" style="margin: 0 15px;" value="Enviar" class="btn roberto-btn mt-15">Remover</button>
